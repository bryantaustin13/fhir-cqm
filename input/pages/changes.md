...
* **Applied**: Additional metadata for measure report | quality statement ([FHIR-20699](https://jira.hl7.org/browse/FHIR-20699)) Applied ([here](StructureDefinition-cqm-publishablemeasure.html)), ([here](StructureDefinition-cqm-limitations.html)), ([here](StructureDefinition-cqm-trendingIssues.html)), and ([here](measure-cqm-publishable-example.html))
